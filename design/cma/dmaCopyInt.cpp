...
int main() {
    ...
    *((int*)ptr_one)=25;
    ...
    printf("Memory value of pointer one %d\n", number);
    printf("Memory value of pointer two %d\n", number2);

    // ----------------------------------------------
    //  getting phy addresses
    // ----------------------------------------------

    unsigned long long phy_address1 = cma_get_phy_addr(ptr_one);
    unsigned long long phy_address2 = cma_get_phy_addr(ptr_two);
    ...
    number2 = *(unsigned int*)ptr_two;
    number = *(unsigned int*)ptr_one;
    printf("New Memory value of pointer one %d\n", number);
    printf("New Memory value of pointer two %d\n", number2);
