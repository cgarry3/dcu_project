...
xilinx.com:hls:vehicleCountDebug8:1.0\
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  # Create instance: vehicleCountDebug8_0, and set properties
  set vehicleCountDebug8_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:vehicleCountDebug8:1.0 vehicleCountDebug8_0 ]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins vehicleCountDebug8_0/stream_in]
  ...
  connect_bd_intf_net -intf_net s_axi_AXILiteS_1 [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins vehicleCountDebug8_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net vehicleCountDebug8_0_stream_out [get_bd_intf_pins axis_register_slice_1/S_AXIS] [get_bd_intf_pins vehicleCountDebug8_0/stream_out]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_100M] [get_bd_pins frontend/clk_100M]
  connect_bd_net -net Net1 [get_bd_pins periph_resetn_clk100M] [get_bd_pins frontend/periph_resetn_clk100M]
  connect_bd_net -net RefClk_1 [get_bd_pins clk_200M] [get_bd_pins frontend/clk_200M]
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins color_convert/control] [get_bd_pins frontend/clk_142M] [get_bd_pins pixel_pack/ap_clk] [get_bd_pins pixel_pack/control] [get_bd_pins vehicleCountDebug8_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n_control] [get_bd_pins vehicleCountDebug8_0/ap_rst_n]
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M10_AXI [get_bd_intf_pins axi_interconnect_0/M10_AXI] [get_bd_intf_pins hdmi_in/s_axi_AXILiteS]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins video/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_interrupts/s_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins video/s_axi_AXILiteS]
  ...
  connect_bd_net -net proc_sys_reset_fclk1_peripheral_aresetn [get_bd_pins proc_sys_reset_fclk1/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins video/periph_resetn_clk142M]
  ...
  connect_bd_net -net ps7_0_FCLK_CLK1 [get_bd_pins proc_sys_reset_fclk1/slowest_sync_clk] [get_bd_pins ps7_0/FCLK_CLK1] [get_bd_pins ps7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins video/clk_142M]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs video/hdmi_in/vehicleCountDebug8_0/s_axi_AXILiteS/Reg] SEG_vehicleCountDebug8_0_Reg
