...
xilinx.com:hls:rgb2grayScale_filter:1.0\
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  # Create instance: rgb2grayScale_filter_0, and set properties
  set rgb2grayScale_filter_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:rgb2grayScale_filter:1.0 rgb2grayScale_filter_0 ]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins rgb2grayScale_filter_0/INPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net rgb2grayScale_filter_0_OUTPUT_STREAM [get_bd_intf_pins axis_register_slice_1/S_AXIS] [get_bd_intf_pins rgb2grayScale_filter_0/OUTPUT_STREAM]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_100M] [get_bd_pins frontend/clk_100M]
  connect_bd_net -net Net1 [get_bd_pins periph_resetn_clk100M] [get_bd_pins frontend/periph_resetn_clk100M]
  connect_bd_net -net RefClk_1 [get_bd_pins clk_200M] [get_bd_pins frontend/clk_200M]
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins color_convert/control] [get_bd_pins frontend/clk_142M] [get_bd_pins pixel_pack/ap_clk] [get_bd_pins pixel_pack/control] [get_bd_pins rgb2grayScale_filter_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n_control] [get_bd_pins rgb2grayScale_filter_0/ap_rst_n]
