...
xilinx.com:hls:vehicleCount:1.0\
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  # Create instance: vehicleCount_0, and set properties
  set vehicleCount_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:vehicleCount:1.0 vehicleCount_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins vehicleCount_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins vehicleCount_0/stream_in]
  ...
  connect_bd_intf_net -intf_net vehicleCount_0_stream_out [get_bd_intf_pins axis_register_slice_1/S_AXIS] [get_bd_intf_pins vehicleCount_0/stream_out]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_100M] [get_bd_pins frontend/clk_100M]
  connect_bd_net -net Net1 [get_bd_pins periph_resetn_clk100M] [get_bd_pins frontend/periph_resetn_clk100M]
  connect_bd_net -net RefClk_1 [get_bd_pins clk_200M] [get_bd_pins frontend/clk_200M]
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins color_convert/control] [get_bd_pins frontend/clk_142M] [get_bd_pins pixel_pack/ap_clk] [get_bd_pins pixel_pack/control] [get_bd_pins vehicleCount_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n_control] [get_bd_pins vehicleCount_0/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs video/hdmi_in/vehicleCount_0/s_axi_AXILiteS/Reg] SEG_vehicleCount_0_Reg
